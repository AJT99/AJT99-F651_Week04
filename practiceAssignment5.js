...
function leetSpeak(word)
{
    ...
    {
        if(word.charAt(i) == 'e' && (word.charAt(i) == word.charAt(i).toLowerCase()))
        {
            word = word.substring(0, i) + '3' + word.substring(i + 1);
        }
        else if(word.charAt(i) == 'a' && (word.charAt(i) == word.charAt(i).toLowerCase()))
        {
            word = word.substring(0, i) + '4' + word.substring(i + 1);
        }
    }
    return word;
}